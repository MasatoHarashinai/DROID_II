...
{
	i_TitleLabel = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Label_TITLE.png"));
	i_background = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "BackGround.png"));
	i_background_title = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "BackGround_Title.png"));
	i_Warning = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Warning.png"));
	i_StartLabel = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Label_START.png"));
	i_SelectStartLabel = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Label_START_SELECT.png"));
	i_ExitLabel = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Label_EXIT.png"));
	i_SelectExitLabel = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Label_EXIT_SELECT.png"));
	i_sidebar = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "SideBar.png"));
	i_underbar = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "UnderBar.png"));
	i_HPLabel1 = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "HP1.png"));
	i_HPLabel2 = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "HP2.png"));
	i_HPLabel3 = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "HP3.png"));
	i_LevelLavel = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Label_Level.png"));
	i_star = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Star.png"));
	i_numbers[0] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_0.png"));
	i_numbers[1] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_1.png"));
	i_numbers[2] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_2.png"));
	i_numbers[3] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_3.png"));
	i_numbers[4] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_4.png"));
	i_numbers[5] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_5.png"));
	i_numbers[6] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_6.png"));
	i_numbers[7] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_7.png"));
	i_numbers[8] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_8.png"));
	i_numbers[9] = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "n2_9.png"));
	s_bgm = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "BGM4.mp3"));
	ChangeVolumeSoundMem( 255 * 30 / 100, s_bgm );
	s_boss_bgm = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "BossBGM.mp3"));
	ChangeVolumeSoundMem( 255 * 35 / 100, s_boss_bgm);
	s_title_bgm = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "BGM6.mp3"));
	ChangeVolumeSoundMem( 255 * 30 / 100, s_title_bgm );
	s_warning = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "Warning.wav"));
	ChangeVolumeSoundMem( 255 * 30 / 100, s_warning );
	s_decide = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "Decide.mp3"));
	ChangeVolumeSoundMem( 255 * 50 / 100, s_decide );
	s_move_cursor = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "MoveCursor.mp3"));
