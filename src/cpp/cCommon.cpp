...
{
	i_body = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Common1.png")); // メモリに自機の画像を書き込む
	i_body2 = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Boss.png"));
	s_dead = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "CommonDead.wav"));	// メモリに倒された時の音を書き込む
