...
{
	i_body = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Missile.png"));
	s_fire = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "MissileFire.mp3"));
	graph_beam = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Beam.png"));
	graph_laser = LoadGraph(RSC_PATH(RSC_IMG_PREFIX, "Laser.png"));
	sound_beam = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "BeamFire.mp3"));
	sound_laser = LoadSoundMem(RSC_PATH(RSC_SND_PREFIX, "LaserFire.wav"));
