...
{
	i_body[0] = LoadGraph("image/Barriar1.png");
	i_body[1] = LoadGraph("image/Barriar2.png");
	i_body[2] = LoadGraph("image/Barriar3.png");
	s_create = LoadSoundMem("sound/BarriarCreate.mp3");
