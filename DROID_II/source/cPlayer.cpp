...
{
	i_body = LoadGraph("image/blueS01b.png");	// プレイヤーの画像を設定する
	...
	s_dead = LoadSoundMem("sound/PlayerDead.mp3");	  // 音声ファイルの識別番号を保存
	ChangeVolumeSoundMem( 255 * 45 / 100, s_dead );	  //			&	
	s_danger = LoadSoundMem("sound/PlayerDanger.mp3");//　　　ボリュームの設定
